                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"
                                        id="basic-layout-form"> {{__('admin/profile.modify profile')}} </h4>
                                        ...
                                        <form class="form" action="{{route('update.profile')}}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label
                                                            for="password"> {{__('admin/profile.new password')}} </label>
                                                ...
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        <label
                                                            for="password_confirmation">{{__('admin/profile.confirm password')}} </label>
